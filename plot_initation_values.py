...
df["Full Initiation Count"] = df["Full Initiation Count"]/len(df["Full Initiation Count"])*100
df["Partial Initiation Count"] =  df["Partial Initiation Count"]/len(df["Partial Initiation Count"])*100
df["Initiation"] =  df["Initiation"]/len(df["Initiation"])*100
print(df)
